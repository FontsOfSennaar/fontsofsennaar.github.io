...
To enabled them to be entered via 'typing', I changed certain ligatures into in-game glyphs. Before using the font, please make sure that font ligatures are enabled. 
<br>
